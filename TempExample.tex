...
\newcommand{\authorsup}[1]{\raisebox{0.7ex}{\fontsize{7pt}{7pt}\selectfont #1}}
...
\title{
\vspace{2.39cm} \xiaoerhao\textbf{中文题名中文题名} \xiaowuhao （中文题名不超过20字，英文题名不超过10个实词）\vspace{0.4cm}
}
...
\author{
\sihao 张某\authorsup{1,*}，吕某某\authorsup{2}，诸葛某\authorsup{1}，欧阳某某\authorsup{1}\\[0.3cm]
\xiaowuhao 1.~~南京航空航天大学~~航空宇航学院，南京~~210016\\
\xiaowuhao 2.~~北京航空航天大学~~航空科学与工程学院，北京~~100191
}
...
\liuhao 
\parbox{\textwidth}{%
 {\CJKfontspec[FakeSlant = 0.2]{SimHei}引用格式:}%
 {\simsong 张某, 吕某某, 诸葛某, 等. 中文题名中文题名中文题名中文题名\textit{[J]}. 航空学报, \textit{2017, 38(x): XXXXXX. ZHANG M, LYU M M, ZHU M,}\\[-0.5em]
...
\begin{tabularx}{0.95\linewidth}{Y Y !{\vrule width 1pt} Y Y}
...
\begingroup
\renewcommand{\arraystretch}{1.3}
\begin{tabularx}{\linewidth}{>{\hsize=0.8\hsize\centering\arraybackslash}X >{\hsize=1.0\hsize\centering\arraybackslash}X >{\hsize=0.95\hsize\centering\arraybackslash}X >{\hsize=1.3\hsize\centering\arraybackslash}X >{\hsize=0.95\hsize\centering\arraybackslash}X}
\specialrule{1pt}{0pt}{0pt}
...
{\xiaosihao ZHANG Mou\authorsup{1,*}, LI Moumou\authorsup{2}, ZHUGE Mou\authorsup{1}, OUYANG Moumou\authorsup{1}}\\[0.3cm]
\xiaowuhao{
...
2. \textbf{\textit{\ArialFont School of Aeronautic Science and Engineering, Beihang University, Beijing 100191, China}}}
